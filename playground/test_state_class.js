        ...
        clearStorage: function (name) {
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, _list[name].clearStorage()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    refSectionTitle = stateList.caller(
                ...
                case 2:
                    ...
                    return [
                        4 /*yield*/,
                        refSubtitles.setState(dummyData.subtitles),
                    ];
                case 3:
                    _j.sent();
                ...
                case 4:
                    ...
                    return [
                        4 /*yield*/,
                        refSectionTitle.setState(dummyData.sectionTitle),
                    ];
                case 5:
                    _j.sent();
                    // MAKE SURE:
